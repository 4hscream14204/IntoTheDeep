...
public class MeepMeepOR {
    public static void main(String[] args) {
        ...
        myBot.runAction(myBot.getDrive().actionBuilder(new Pose2d(-14, 61, Math.toRadians(270)))
                ...
                //30
                // .setTangent(90)
                .splineToLinearHeading(new Pose2d(-34.00, 34.00, Math.toRadians(130.00)), Math.toRadians(180.00), new TranslationalVelConstraint(20))
                ...
                .waitSeconds(0.1)
                .splineToLinearHeading(new Pose2d(-55.00, 39.00, Math.toRadians(20.00)), Math.toRadians(120.00), new TranslationalVelConstraint(20))
                .waitSeconds(0.1)
