...
@TeleOp(name="ascend robot")
public class Assent_bot extends OpMode{

    DcMotor frontLeftMotor;
    DcMotor frontRightMotor;
    DcMotor backLeftMotor;
    DcMotor backRightMotor;
    DcMotorSimple ascensionMotor;
    ...
    public void init() {
        ...
        ascensionMotor = hardwareMap.get(DcMotorSimple.class,"ascensionMotor");
