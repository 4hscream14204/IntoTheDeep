...
@Autonomous(name = "GripForce")
public class GripForceTest extends OpMode{
    private int pathState;
    private Follower follower;
    private Timer pathTimer, actionTimer, opmodeTimer;
    private DashboardCore dashboardCore;
    private final Pose beginningPose = new Pose(9, 84.983, 0);
    private final Pose startPose = new Pose(36, 84.983, 0);
    ...
    @Override
    public void loop() {
        velocity = 24/opmodeTimer.getElapsedTimeSeconds();
