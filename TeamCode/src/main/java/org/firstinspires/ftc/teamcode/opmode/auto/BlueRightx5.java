...
public class BlueRightx5 extends OpMode {
    ...
    public void init() {
        ...
        blueRightx4Action = robotBase.drive.actionBuilder(startPose)
                ...
                .splineToSplineHeading(new Pose2d(-31, 36.00,Math.toRadians(180)), Math.toRadians(270.00), new TranslationalVelConstraint(30))
                ...
                .splineToConstantHeading(new Vector2d(-22, 15), Math.toRadians(270), new TranslationalVelConstraint(40))
                ...
                .splineToConstantHeading(new Vector2d(-39, 15), Math.toRadians(270),new TranslationalVelConstraint(40))
                //push to human player
                .splineToConstantHeading(new Vector2d(-46, 15), Math.toRadians(90),new TranslationalVelConstraint(28))
                .splineToConstantHeading(new Vector2d(-46, 44), Math.toRadians(90),new TranslationalVelConstraint(40))
                ...
                .splineToConstantHeading(new Vector2d(-57, 44), Math.toRadians(90),new TranslationalVelConstraint(40))
                //.setTangent(Math.toRadians(270))
                ...
                .splineToSplineHeading(new Pose2d(-2.5, 27.00, Math.toRadians(358.00)), Math.toRadians(300), new TranslationalVelConstraint(40))
                .afterTime(0.0, ()->CommandScheduler.getInstance().schedule(new HangSpecimenAutoCommandGroup(robotBase)))
                .waitSeconds(0.1)
                ...
                //hang specimen
                .setTangent(Math.toRadians(315))
                .splineToSplineHeading(new Pose2d(-2.5, 27, Math.toRadians(358.00)), Math.toRadians(300), new TranslationalVelConstraint(40))
                ...
                //hang specimen
                .setTangent(Math.toRadians(315))
                .splineToSplineHeading(new Pose2d(-2.5, 30, Math.toRadians(358.00)), Math.toRadians(300), new TranslationalVelConstraint(40))
                .afterTime(0.0, ()->CommandScheduler.getInstance().schedule(new HangSpecimenAutoCommandGroup(robotBase)))
                .waitSeconds(0.1)
                //go and grab another specimen
                .setTangent(Math.toRadians(100))
