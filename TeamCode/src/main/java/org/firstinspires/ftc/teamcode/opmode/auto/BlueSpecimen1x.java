...
@Autonomous (name = "BlueSpecimen1x")
public class BlueSpecimen1x extends OpMode {
    ...
    public void init() {
        ...
        blueRightx4Action = robotBase.drive.actionBuilder(startPose)
                ...
                .splineToConstantHeading(new Vector2d(-2.0, 26.00), Math.toRadians(270.00), new TranslationalVelConstraint(40))
                ...
                .splineToConstantHeading(new Vector2d(-41, 64), Math.toRadians(180), new TranslationalVelConstraint(35))
/*
