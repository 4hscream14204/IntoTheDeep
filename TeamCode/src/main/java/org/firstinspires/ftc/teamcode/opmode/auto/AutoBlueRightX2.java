...
public class AutoBlueRightX2 extends OpMode {
    ...
    public void init() {
        ...
        blueRightAction = robotBase.drive.actionBuilder(startPose)
                ...
                .splineToConstantHeading(new Vector2d(-40, 67), Math.toRadians(180.00))
                .splineToConstantHeading(new Vector2d(-56, 67), Math.toRadians(180.00), new TranslationalVelConstraint(20))
                .build();
