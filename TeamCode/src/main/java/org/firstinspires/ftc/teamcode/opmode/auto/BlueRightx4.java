...
public class BlueRightx4 extends OpMode {
    ...
    public void init() {
        ...
        blueRightx4Action = robotBase.drive.actionBuilder(startPose)
                ...
                .splineToConstantHeading(new Vector2d(-45, 17), Math.toRadians(270),new TranslationalVelConstraint(30))
                // .setTangent(90)
                //push to human player
                .splineToConstantHeading(new Vector2d(-55, 18), Math.toRadians(90),new TranslationalVelConstraint(30))
                .splineToConstantHeading(new Vector2d(-55, 50), Math.toRadians(90),new TranslationalVelConstraint(30))
                .setTangent(Math.toRadians(270))
                //back up and wait
                ...
                .setTangent(Math.toRadians(90))
                .splineToConstantHeading(new Vector2d(-47.25, 54), Math.toRadians(90), new TranslationalVelConstraint(30))
                .splineToConstantHeading(new Vector2d(-47.25, 64), Math.toRadians(90), new TranslationalVelConstraint(30))
                ...
                .setTangent(Math.toRadians(90))
                .splineToLinearHeading(new Pose2d(-46.8, 58.00, Math.toRadians(180.00)), Math.toRadians(90.00), new TranslationalVelConstraint(30))
                .splineToConstantHeading(new Vector2d(-46.8, 64), Math.toRadians(90), new TranslationalVelConstraint(30))
                 .afterTime(0.0, ()->CommandScheduler.getInstance().schedule(new GrabSpecimenAndHangPosCommandGroup(robotBase)))
                .waitSeconds(0.2)
                //hang specimen
                .setTangent(Math.toRadians(270))
