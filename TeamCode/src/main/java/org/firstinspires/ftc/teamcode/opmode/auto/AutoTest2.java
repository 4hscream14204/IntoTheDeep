...
public class AutoTest2 extends OpMode {public TelemetryPacket telemetryPacket;
    ...
    public void init() {
        ...
        blueLeftAction = robotBase.drive.actionBuilder(startPose)
                ...
                .splineToConstantHeading(new Vector2d(-6.0, 35), Math.toRadians(90), new TranslationalVelConstraint(20))
                //30
                // .setTangent(90)
                .splineToLinearHeading(new Pose2d(-34.00, 36.00, Math.toRadians(130.00)), Math.toRadians(180.00), new TranslationalVelConstraint(20))
                .setTangent(Math.toRadians(180))
                .splineToLinearHeading(new Pose2d(-38.00, 40, Math.toRadians(50)), Math.toRadians(90), new TranslationalVelConstraint(20))
                ...
                .splineToLinearHeading(new Pose2d(-42.00, 34.00, Math.toRadians(120.00)), Math.toRadians(200.00), new TranslationalVelConstraint(20))
                .waitSeconds(0.1)

                .splineToLinearHeading(new Pose2d(-47.00, 41.00, Math.toRadians(50.00)), Math.toRadians(120.00), new TranslationalVelConstraint(20))
                .waitSeconds(0.1)
                .setTangent(Math.toRadians(200))
                .splineToLinearHeading(new Pose2d(-48.00, 34.00, Math.toRadians(120.00)), Math.toRadians(200.00), new TranslationalVelConstraint(20))
                .waitSeconds(0.1)
                .splineToLinearHeading(new Pose2d(-52.00, 39.00, Math.toRadians(20.00)), Math.toRadians(120.00), new TranslationalVelConstraint(20))
                .waitSeconds(0.1)
                .setTangent(45)
