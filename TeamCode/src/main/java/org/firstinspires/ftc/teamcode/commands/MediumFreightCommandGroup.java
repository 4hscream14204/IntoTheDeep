...
public class MediumFreightCommandGroup extends SequentialCommandGroup {
    public MediumFreightCommandGroup(Lift lift){
        addCommands(
                new InstantCommand(()->lift.goToPosition(Lift.LiftPosition.MEDIUMDROPOFF)),
                new WaitUntilCommand(()->lift.isAtPosition(Lift.LiftPosition.MEDIUMDROPOFF)),
                new WaitCommand(200),
