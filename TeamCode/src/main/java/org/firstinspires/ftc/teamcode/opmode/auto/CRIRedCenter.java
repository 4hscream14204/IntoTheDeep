...
public class CRIRedCenter extends OpMode{
    ...
    public void init() {
        ...
        blueLeftAction = robotBase.drive.actionBuilder(startPose)
                ...
                .setTangent(90)
                //Chamber avoidence
                .splineToConstantHeading(new Vector2d(-27, 16.8), Math.toRadians(180), new TranslationalVelConstraint(30))
                //Chamber drop off
                .splineToConstantHeading(new Vector2d(-56, 16.4), Math.toRadians(180), new TranslationalVelConstraint(30))
                .splineToConstantHeading(new Vector2d(-56, 11), Math.toRadians(180), new TranslationalVelConstraint(20))
                ...
                .waitSeconds(0.5)
                .splineToConstantHeading(new Vector2d(-56, 15.0), Math.toRadians(180), new TranslationalVelConstraint(20))
                .setTangent(45)
                ...
                .splineToConstantHeading(new Vector2d(-44, 17.8), Math.toRadians(0), new TranslationalVelConstraint(20))
                .waitSeconds(0.4)
                .setTangent(0)
                //First sample drop off
                .splineToConstantHeading(new Vector2d(-10, 16.8), Math.toRadians(180), new TranslationalVelConstraint(20))
                ...
                .splineToConstantHeading(new Vector2d(-53, 17.5), Math.toRadians(0), new TranslationalVelConstraint(20))
                ...
                .splineToConstantHeading(new Vector2d(-10, 16.8), Math.toRadians(180), new TranslationalVelConstraint(30))
                .afterTime(0.0, ()->CommandScheduler.getInstance().schedule((new InstantCommand(()->robotBase.sweeperSubsystem.goToPosition(Sweeper.SweeperPosition.OUT)))))
                //Third sample return
                .splineToConstantHeading(new Vector2d(-63, 16.8), Math.toRadians(0), new TranslationalVelConstraint(20))
                .afterTime(0.0, ()->CommandScheduler.getInstance().schedule((new InstantCommand(()->robotBase.sweeperSubsystem.goToPosition(Sweeper.SweeperPosition.MIDDLE)))))
                .waitSeconds(0.4)
                .setTangent(0)
