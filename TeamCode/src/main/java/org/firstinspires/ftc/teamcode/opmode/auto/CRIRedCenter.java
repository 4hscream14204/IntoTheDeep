...
public class CRIRedCenter extends OpMode{
    ...
    public void init() {
        ...
        blueLeftAction = robotBase.drive.actionBuilder(startPose)
                ...
                .setTangent(90)
                //Chamber avoidence
                .splineToConstantHeading(new Vector2d(-27, 16.4), Math.toRadians(180), new TranslationalVelConstraint(40))
                //Chamber drop off
                .splineToConstantHeading(new Vector2d(-56, 15.4), Math.toRadians(180), new TranslationalVelConstraint(20))
                ...
                .splineToConstantHeading(new Vector2d(-56, 10), Math.toRadians(180), new TranslationalVelConstraint(30))
                ...
                .waitSeconds(0.5)
                .splineToConstantHeading(new Vector2d(-56, 15.0), Math.toRadians(180), new TranslationalVelConstraint(30))
                .setTangent(45)
                ...
                .afterTime(.5, ()->CommandScheduler.getInstance().schedule((new InstantCommand(()->robotBase.sweeperSubsystem.goToPosition(Sweeper.SweeperPosition.MIDDLE)))))
                ...
                .splineToConstantHeading(new Vector2d(-10, 16.8), Math.toRadians(180), new TranslationalVelConstraint(40))
                ...
                */
                ...
                .afterTime(0.0, ()->CommandScheduler.getInstance().schedule((new InstantCommand(()->robotBase.sweeperSubsystem.goToPosition(Sweeper.SweeperPosition.OUT)))))
                .waitSeconds(0.2)
                .splineToConstantHeading(new Vector2d(0, 16.8), Math.toRadians(0), new TranslationalVelConstraint(30))
                ...
                .afterTime(0, ()->CommandScheduler.getInstance().schedule((new InstantCommand(()->robotBase.shoulderSubsystem.goToPosition(Shoulder.ShoulderPosition.AUTOAVOIDENCE)))))
                .splineToConstantHeading(new Vector2d(-56, 17.5), Math.toRadians(180), new TranslationalVelConstraint(30))
                .afterTime(0, ()->CommandScheduler.getInstance().schedule((new InstantCommand(()->robotBase.shoulderSubsystem.goToPosition(Shoulder.ShoulderPosition.AUTOPARK)))))
                .splineToConstantHeading(new Vector2d(-57, 10), Math.toRadians(180), new TranslationalVelConstraint(30))
                .afterTime(0, ()->CommandScheduler.getInstance().schedule((new InstantCommand(()->robotBase.extensionSubsystem.goToPosition(Extension.ExtensionPosition.HIGHCHAMBERCLAMP)))))
                ...
                .splineToSplineHeading(new Pose2d(-20.0, 17.0, Math.toRadians(0.00)), Math.toRadians(180.00), new TranslationalVelConstraint(30))
                .afterTime(0, ()->CommandScheduler.getInstance().schedule((new InstantCommand(()->robotBase.shoulderSubsystem.goToPosition(Shoulder.ShoulderPosition.AUTOAVOIDENCE)))))
                .splineToConstantHeading(new Vector2d(-56, 15.8), Math.toRadians(180), new TranslationalVelConstraint(30))
                .afterTime(0, ()->CommandScheduler.getInstance().schedule((new InstantCommand(()->robotBase.shoulderSubsystem.goToPosition(Shoulder.ShoulderPosition.AUTOPARK)))))
                .splineToConstantHeading(new Vector2d(-55, 10), Math.toRadians(180), new TranslationalVelConstraint(30))
                .afterTime(0, ()->CommandScheduler.getInstance().schedule((new InstantCommand(()->robotBase.extensionSubsystem.goToPosition(Extension.ExtensionPosition.HIGHCHAMBERCLAMP)))))
                .afterTime(0.4, ()->CommandScheduler.getInstance().schedule((new InstantCommand(()->robotBase.clawSubsystem.openClaw()))))
                .splineToConstantHeading(new Vector2d(-56, 15.0), Math.toRadians(180), new TranslationalVelConstraint(30))
                .setTangent(45)
                ...
                .splineToConstantHeading(new Vector2d(0, 16.8), Math.toRadians(0), new TranslationalVelConstraint(40))
                .afterTime(0.2, ()->CommandScheduler.getInstance().schedule((new InstantCommand(()->robotBase.clawSubsystem.closeClaw()))))
                .afterTime(0.4, ()->CommandScheduler.getInstance().schedule((new InstantCommand(()->robotBase.extensionSubsystem.goToPosition(Extension.ExtensionPosition.HIGHCHAMBER)))))
                .waitSeconds(0.2)
                .setTangent(180)
                .splineToSplineHeading(new Pose2d(-20.0, 17.0, Math.toRadians(0.00)), Math.toRadians(180.00), new TranslationalVelConstraint(50))
                .afterTime(0, ()->CommandScheduler.getInstance().schedule((new InstantCommand(()->robotBase.shoulderSubsystem.goToPosition(Shoulder.ShoulderPosition.AUTOAVOIDENCE)))))
                .splineToConstantHeading(new Vector2d(-58, 15.8), Math.toRadians(180), new TranslationalVelConstraint(40))
                .afterTime(0, ()->CommandScheduler.getInstance().schedule((new InstantCommand(()->robotBase.shoulderSubsystem.goToPosition(Shoulder.ShoulderPosition.AUTOPARK)))))
                .splineToConstantHeading(new Vector2d(-58, 10), Math.toRadians(180), new TranslationalVelConstraint(30))
                .afterTime(0, ()->CommandScheduler.getInstance().schedule((new InstantCommand(()->robotBase.extensionSubsystem.goToPosition(Extension.ExtensionPosition.HIGHCHAMBERCLAMP)))))
                .afterTime(0.4, ()->CommandScheduler.getInstance().schedule((new InstantCommand(()->robotBase.clawSubsystem.openClaw()))))
                .build();
